...
<dspace:browselist items="<%= (BrowseItem[])info.getItems() %>" config="crisevents.${info[holder.shortName].type}" sortBy="<%= new Integer(info.getSo().getNumber()).toString() %>" order="<%= info.getOrder() %>"/>
</div>
</div>
